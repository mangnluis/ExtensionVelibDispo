...
function calculateHaversineDistance(lat1, lon1, lat2, lon2) {
  ...
  /**
   * Décode un polyline en coordonnées
   * @param {string} encoded - Polyline encodé
   * @return {Array} Tableau de points [lat, lng]
   */
  ...
  /**
   * Détecte la position actuelle de l'utilisateur
   * @return {Promise<Object>} Position {lat, lng}
   */
